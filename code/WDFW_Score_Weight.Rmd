...
#Sunny and Braeden asked me to add a dashed line for the other potential ESA listed runs that don't currently exist, but theoretically could exist.
...
WDFWCost <- ggplot(data = Cost, aes(x = H, y = PI, color = Scenario))+
  geom_line()+
  theme_classic()+
...
#save figure
ggsave(dpi = 300, units = "in", here("output/WDFW Figures","WDFWCost.tiff"), plot = WDFWCost, 
